...
namespace Graduation.Entities
{
    class Robot1 : Enemy
    {
        ...
        public Robot1(Game game, Vector2 position) : base(game, position, 180, 70, 10, 3, 40)
        {
        ...
        public override void LoadContent(Game game)
        {
            ...
            {
              { "WalkRight", new Animation(game.Content.Load<Texture2D>("Enemy/Robot1WalkRight"), 1) },
              { "WalkLeft", new Animation(game.Content.Load<Texture2D>("Enemy/Robot1WalkLeft"), 1) },
              { "StandRight", new Animation(game.Content.Load<Texture2D>("Enemy/Robot1WalkRight"), 1) },
              { "StandLeft", new Animation(game.Content.Load<Texture2D>("Enemy/Robot1WalkLeft"), 1) },
              { "AttackLeft", new Animation(game.Content.Load<Texture2D>("Enemy/Robot1MeleeLeft"), 1) },
              { "AttackRight", new Animation(game.Content.Load<Texture2D>("Enemy/Robot1MeleeRight"), 1) },
              { "DownRight", new Animation(game.Content.Load<Texture2D>("Enemy/Robot1WalkRight"), 1) },
              { "DownLeft", new Animation(game.Content.Load<Texture2D>("Enemy/Robot1MeleeLeft"), 1) },
              { "RangedRight", new Animation(game.Content.Load<Texture2D>("Enemy/Robot1RangedRight"), 1) },
              { "RangedLeft", new Animation(game.Content.Load<Texture2D>("Enemy/Robot1RangedLeft"), 1) },
